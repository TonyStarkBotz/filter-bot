...
BOT_TOKEN = environ.get('BOT_TOKEN', '7368700990:AAF7Z3qUGJz17yU4pzPJXft4hPqQ825lOhE')
...
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/H7c2ctW/file-4547.jpg')
START_IMG = environ.get('START_IMG', 'https://i.ibb.co/YPkpNmj/file-4548.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002243718353'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002325361324'))
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002171602351'))
